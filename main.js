            ...
            case 'IcosahedronGeometry':
                if (currentcolor == 0xF66120) {
                    if (planetViewed == 0) {
                        ...
                        info.innerHTML = " <span>Elevate your brand</span> with tailored creative solutions,";
                 
                        description.innerHTML = "Transform your vision into a <span>bold</span> digital future<br/><br/><div>Click on the other planets to learn more ...<div>";
                    }
                ...
                if (currentcolor == 0x26D7E7) {
                    if (planetViewed == 1 || planetViewed==3 || planetViewed==4) {
                        planetViewed = 2;
                    info.innerHTML = " <span id='couleur'>A new meaning to branding</span> with our refined approaches,";
                 
                                               document.getElementById('couleur').style.color="#26d7e7";

                        description.innerHTML = "animations, logo design, social media templates, banners...<br/><br/><div>Click on the other planets to learn more ...<div>";
                   ...
                   if (currentcolor == 0xffc12d) {
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==4) {
                        planetViewed = 3;
                        info.innerHTML = '<span id="couleur">Website Design & Development</span> for diverse projects';
                      
                         
                        description.innerHTML = "smart design meets strategic structure; from SEO to sales!<br/><br/><div>Click on the other planets to learn more ...<div>";
                    ...
                    if (planetViewed == 1 || planetViewed==2 || planetViewed==3) {
                        planetViewed = 4;
                        info.innerHTML = '<span id="couleur">Get in touch</span> for a customized project evaluation.';
                         document.getElementById('couleur').style.color="#acacac";
                  
                        description.innerHTML = "follow us on social media for updates and templates or drop us an email<br/><br/><div>Click on the other planets to learn more ...<div>";
